...
public final class UtilReflection {
     ...
     *
     * @param clazz     Target class
     * @param arguments Arguments which are used to build an object of the target class
     ...
     * @see #getField(Class, boolean, String)
     */
    public static <T> T getValue(Object instance, Class<?> clazz, boolean declared, String fieldName) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
        return (T) getField(clazz, declared, fieldName).get(instance);
    }
     ...
     */
    public static <T> T getValue(Object instance, String className, PackageType packageType, boolean declared, String fieldName) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
        return (T) getValue(instance, packageType.getClass(className), declared, fieldName);
    }
     ...
     * <p/>
     * This class is part of the <b>UtilReflection</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.0
     */
